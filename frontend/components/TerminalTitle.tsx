...
export default function TerminalTitle() {
  ...
  return (
    <>
      ...
      <h1
        aria-hidden="true"
        className="text-lg sm:text-xl md:text-4xl lg:text-5xl font-mono font-semibold tracking-tight text-white flex justify-center items-center drop-shadow-[0_0_14px_rgba(56,189,248,0.35)] whitespace-nowrap"
      >
        {displayed}
