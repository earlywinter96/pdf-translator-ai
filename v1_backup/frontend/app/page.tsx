...
function TerminalTitle() {
  const TEXT = "< LipiTranslate – PDF Translator >";
      ...
      <main className="relative min-h-screen bg-gradient-to-br from-[#020617] to-black overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-24 pb-20">
          ...
          <div className="text-center space-y-8 mb-20">
            ...
            {/* SEO-only H1 for Google */}
            <h1 className="sr-only">
              Free Online PDF Translator for Gujarati, Hindi & Marathi
            </h1>
...
<div className="mt-12 space-y-2 text-sm text-gray-400">
  <Link href="/gujarati-to-hindi-pdf-translator" className="block hover:text-white">
    Gujarati to Hindi PDF Translator
  </Link>

  <Link href="/hindi-to-english-pdf-translator" className="block hover:text-white">
    Hindi to English PDF Translator
  </Link>

  <Link href="/marathi-to-english-pdf-translator" className="block hover:text-white">
